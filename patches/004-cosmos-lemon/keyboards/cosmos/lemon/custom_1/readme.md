...
```bash
qmk compile -kb cosmos/lemon/custom_1 -km default
qmk flash -kb cosmos/lemon/custom_1 -km default -bl uf2-split-left
qmk flash -kb cosmos/lemon/custom_1 -km default -bl uf2-split-right
```
